# -*- coding: utf-8 -*-
"""Cópia de DML_parte1_icmc.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Zusur4expqs02FdZIaAPIx90qHshZZf7
"""
...
ds_train = torchvision.datasets.ImageFolder("./pessoas/train",transform=transform)
ds_test = torchvision.datasets.ImageFolder("./pessoas/test",transform=transform)
...
while not stop:
    ...
    with torch.no_grad():
        ...
        batch_loss_test.append(np.nanmean(batch_list_loss))
    ...
    if batch_loss_test[-1] < best_loss:
        ...
        save_model = {'model': model.state_dict(), 'opt': opt.state_dict(), 'loss_training': batch_loss}
