"""
Here will be implemented a cross validation with multiples threshold for better measure of pairs.
"""
...
if __name__ == '__main__':
    ...
    root_directory = "/app/Recognition/arcface_torch/megaface/data/facescrub_images"
    ...
    for pair in itertools.combinations(identities, 2):
        ...
        pairs = list(itertools.product(images1[:3], images2[:3]))
